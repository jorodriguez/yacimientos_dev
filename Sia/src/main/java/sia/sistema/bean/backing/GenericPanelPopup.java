...
//    /**
//     * Inicializa la Conversación del GenericPanelPopup y lo agrega al Workspace
//     * Este método se ejecuta después de realizarse la inicialización del ModuloBeanModel.
//     */
//    @PostConstruct
//    public void init() {
//        System.out.println(">>Iniciada Conversación de PopUp<<");
//        workspace.beginConversationToWorkspace(getConversation());
//    }

...
public class GrupoBean implements Serializable {
    ...
    public void nuevoGrupo() {
        ...
        this.panelPopup.tmGrupo(actionEvent);
    }
...
//            this.miembros = null;
            this.miembros = new ListDataModel(this.grupoListModel.getMiembros(getGrupo().getId()));
            this.panelPopup.tmElimnarGrupo(actionEvent);
        } catch (Exception e) {
            Logger.getLogger(GrupoBean.class.getName()).log(Level.SEVERE, null, e);
            ...
            if (!this.usuario.equals("")) {
                if (this.grupo != null) {
                    ...
                    if (miembro != null) {
                        ...
                        Usuario userTemp = this.usuarioListModel.buscarPorNombre(this.usuario);
                        if (userTemp != null) {

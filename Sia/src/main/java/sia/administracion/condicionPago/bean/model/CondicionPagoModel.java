...
public class CondicionPagoModel {
    ...
    public void guardarAltaCondicionReturn() {          
        if (getNomConPago().toUpperCase().contains("ANTICIP")) {  
            this.setCondicionPago(getCondicionPagoServicioRemoto().guardarAltaCondicionReturn(getNomConPago(), Constantes.BOOLEAN_TRUE, getSesion().getUsuario()));
        
        } else {
            this.setCondicionPago(getCondicionPagoServicioRemoto().guardarAltaCondicionReturn(getNomConPago(), Constantes.BOOLEAN_FALSE, getSesion().getUsuario()));
        }
    }   
    
    public void guardarProveedorConPago() { 
        this.getOcProveedorConPagoImpl().guardarProveedorConPago(this.getCondicionPago(), this.getPro(), getSesion().getUsuario(), getRfcCompania());
        this.getAllConPagoProveedor();
    }
    
    public void actualizarProveedorConPago() {                
        this.ocProveedorConPagoImpl.actualizarProveedorConPago(this.getProveedorConPagoVo(), this.getCondicionPago(), getSesion().getUsuario());    
        this.getAllConPagoProveedor();
    }
...
/************ AUTO-COMPLETAR Condicion de Pago *****************************************************/
    ...
    public SoporteProveedor getSoporteProveedor() {
        return soporteProveedor;
    }

...
//    public List<CadenasMando> buscarCadenaPorSolicta(String solicita, int idApCampo) {
//        return this.cadenasMandoServicioRemoto.traerPorCadenaPorSolicita(solicita, idApCampo, false);
//    }
    /**
     * @param cadena
    ...
    public List<SelectItem> regresaUsuarioActivo(String cadena) {
        UtilLog4j.log.info(this, "Cadena: " + cadena);
        UtilLog4j.log.info(this, "Campo usuario: " + getIdCampo());
        setListaUsuarios(soporteProveedor.regresaUsuarioActivo(cadena, getIdCampo(), "nombre", true, true, false));
        return getListaUsuarios();

    }
    
    public List<SelectItem> regresaUsuarioCampo(String cadena) {
        UtilLog4j.log.info(this, "Cadena: " + cadena);
        UtilLog4j.log.info(this, "Campo usuario: " + getIdCampo());
        setListaUsuarios(soporteProveedor.regresaUsuarioCampo(cadena, getIdCampo(), "nombre", true, true, false));
        return getListaUsuarios();

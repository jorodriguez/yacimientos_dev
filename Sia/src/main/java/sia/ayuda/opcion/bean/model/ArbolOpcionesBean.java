...
public class ArbolOpcionesBean implements Serializable {
    ...
    @Inject
    public ArbolOpcionesBean(Conversation conversacion, ConversationsManager conversationsManager, SiModuloImpl siModuloImpl,SiOpcionImpl siOpcionImpl, 
    SiRolImpl siRolImpl,SiRelRolOpcionImpl siRelRolOpImpl) {
        ...
        this.conversationsManager.beginConversation(conversacion, Constantes.CONVERSACION_CATALOGO_OPCIONES);
        this.siModuloImpl = siModuloImpl;
        this.siOpcionImpl = siOpcionImpl;
        this.siRolImpl = siRolImpl;
        this.siRelRolOpImpl=siRelRolOpImpl;
    ...
    public void ReloadArbolOpciones(){     
            this.conversationsManager.finalizeConversation(Constantes.CONVERSACION_CATALOGO_OPCIONES); //Terminando todas las conversaciones abiertas hasta este momento
        //Iniciando la conversación
        this.conversationsManager.beginConversation(conversacion, Constantes.CONVERSACION_CATALOGO_OPCIONES);

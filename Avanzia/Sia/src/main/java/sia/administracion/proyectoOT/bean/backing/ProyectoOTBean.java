...
public class ProyectoOTBean implements Serializable {
    ...
    public void traerProyectoOtPorNombre(String texto) {
        proyectoOTModel.setLista(new ListDataModel(proyectoOTModel.traerProyectoOTPorCadena(texto)));
    }
...
//            FacesUtils.addInfoMessage("La obra ya está en la base de datos");
    ...
    ////*************************************************************////
    //AUTOCOMPLETE
    public List<String> proyectoOtListener(String texto) {
        List<String> proyectos = new ArrayList<>();
        for (ProyectoOtVo proyecto : proyectoOTModel.cargarListaProyectosOtItems(texto)) {
    ...
    public void onItemSelectRevisa(SelectEvent<String> event) {
        setCuentaContable(event.getObject());
    }

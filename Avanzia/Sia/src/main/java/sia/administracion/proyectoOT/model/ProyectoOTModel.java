...
public class ProyectoOTModel implements Serializable {
    ...
    // AUTOCOMPLETe 
    public List<ProyectoOtVo> cargarListaProyectosOtItems(String cadena) {
        UtilLog4j.log.info(this, "cargarListaProyectosOtItems " + cadena + "   " + idApCampoActivo);
        try {
            List<ProyectoOtVo> pyts = proyectoOtServicioRemoto.getListaProyectosOtPorCampo(idApCampoActivo, cadena, sesion.getUsuario().getApCampo().getCompania().getRfc(), false);

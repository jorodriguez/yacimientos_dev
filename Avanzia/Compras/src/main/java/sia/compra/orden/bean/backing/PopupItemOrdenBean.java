/*
 * PopupItemOrdenBean.java
 * Creado el 24/11/2009, 04:13:47 PM
 ...
 * @date 24/11/2009
 */
@Named (value= PopupItemOrdenBean.BEAN_NAME)
@CustomScoped(value = "#{window}")
public class PopupItemOrdenBean implements Serializable{
  
    //------------------------------------------------------
    public static final String BEAN_NAME = "popupItemOrdenBean";
    //------------------------------------------------------
    ...
    /** Creates a new instance of PopupItemOrdenBean */
    public PopupItemOrdenBean() {
    }

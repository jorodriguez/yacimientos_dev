 ...
 */
@Entity
@Table(name = "CO_MEGUSTA")
@SequenceGenerator(sequenceName = "co_megusta_id_seq", name = "co_megusta_seq", allocationSize = 1)
public class CoMeGusta implements Serializable {
    
    private static final long serialVersionUID = 1L;
    @Id
@GeneratedValue(generator =  "co_megusta_seq", strategy = GenerationType.SEQUENCE)
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CoMeGusta)) {
            return false;
        }
        CoMeGusta other = (CoMeGusta) object;

 ...
 */
@Entity
@Table(name = "CO_COMENTARIO_ME_GUSTA")
@SequenceGenerator(sequenceName = "co_comentario_me_gusta_id_seq", name = "co_comentario_me_gusta_seq", allocationSize = 1)

public class CoComentarioMeGusta implements Serializable {
    
    private static final long serialVersionUID = 1L;
    @Id
@GeneratedValue(generator =  "co_comentario_me_gusta_seq", strategy = GenerationType.SEQUENCE)
    @Basic(optional = false)
    
    @Column(name = "ID")
    private Integer id;
    @JoinColumn(name = "CO_COMENTARIO", referencedColumnName = "ID")
    @ManyToOne
    private CoComentario coComentario;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CoComentarioMeGusta)) {
            return false;
        }
        CoComentarioMeGusta other = (CoComentarioMeGusta) object;
    ...
    public String toString() {
        ...
        sb.append(this.getClass().getName())
            ...
            .append(", coComentario=").append(this.coComentario != null ? this.coComentario.getId() : null)
    ...
    /**
     * @return the coComentario
     */
    public CoComentario getCoComentario() {
        return coComentario;
    }

    /**
     * @param coComentario the coComentario to set
     */
    public void setCoComentario(CoComentario coComentario) {

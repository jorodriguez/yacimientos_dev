...
@Setter
@Table(name = "GR_MAPA")
@SequenceGenerator(sequenceName = "gr_mapa_id_seq", name = "gr_mapa_seq", allocationSize = 1)
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "GrMapa.findAll", query = "SELECT o FROM GrMapa o")})
public class GrMapa implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
@GeneratedValue(generator =  "gr_mapa_seq", strategy = GenerationType.SEQUENCE)

 ...
 */
@Entity
@Table(name = "SG_DET_SOL_EST_SI_MOVI")
@SequenceGenerator(sequenceName = "sg_det_sol_est_si_movi_id_seq", name = "sg_det_sol_est_si_movi_seq", allocationSize = 1)
//@NamedQueries({
    //@NamedQuery(name = "SgSolViajeSiMovimiento.findAll", query = "SELECT s FROM SgSolViajeSiMovimiento s")})
public class SgDetSolEstSiMovi implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
@GeneratedValue(generator =  "sg_det_sol_est_si_movi_seq", strategy = GenerationType.SEQUENCE)
    ...
    public SgDetSolEstSiMovi() {
    }

    public SgDetSolEstSiMovi(Integer id) {
        this.id = id;
    }

    public SgDetSolEstSiMovi(Integer id, Date fechaGenero, Date horaGenero) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SgDetSolEstSiMovi)) {
            return false;
        }
        SgDetSolEstSiMovi other = (SgDetSolEstSiMovi) object;
        ...
        StringBuilder sb = new StringBuilder();
               sb.append(this.getClass().getName())
                .append("{").append("id=").append(this.id)
                       .append(", sgDetalleSolicitudEstancia=").append(this.getSgDetalleSolicitudEstancia())

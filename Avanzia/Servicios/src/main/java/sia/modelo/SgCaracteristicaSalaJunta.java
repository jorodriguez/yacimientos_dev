 ...
 */
@Entity
@Table(name = "SG_CARACTERISTICA_SALA_JUNTA")
@SequenceGenerator(sequenceName = "sg_caracteristica_sala_junta_id_seq", name = "sg_caracteristica_sala_junta_seq", allocationSize = 1)
@NamedQueries({
    @NamedQuery(name = "SgCaracteristicaSalaJunta.findAll", query = "SELECT s FROM SgCaracteristicaSalaJunta s")})
public class SgCaracteristicaSalaJunta implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
@GeneratedValue(generator =  "sg_caracteristica_sala_junta_seq", strategy = GenerationType.SEQUENCE)
    ...
    @JoinColumn(name = "SG_SALA_JUNTA", referencedColumnName = "ID")
    ...
    public SgCaracteristicaSalaJunta() {
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SgCaracteristicaSalaJunta)) {
            return false;
        }
        SgCaracteristicaSalaJunta other = (SgCaracteristicaSalaJunta) object;
    ...
    public String toString() {
        ...
        sb.append(this.getClass().getName())
            ...
            .append(", sgSalaJunta=").append(this.sgSalaJunta != null ? this.sgSalaJunta.getId() : null)

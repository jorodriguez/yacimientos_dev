...
@SequenceGenerator(sequenceName = "si_estado_id_seq", name = "si_estado_seq", allocationSize = 1)
@NamedQueries({
    @NamedQuery(name = "SiEstado.findAll", query = "SELECT e FROM SiEstado e")})
public class SiEstado implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "siEstado")
    private Collection<SiCiudad> siCiudadCollection;
    private static final long serialVersionUID = 1L;
    @Id
@GeneratedValue(generator =  "si_estado_seq", strategy = GenerationType.SEQUENCE)

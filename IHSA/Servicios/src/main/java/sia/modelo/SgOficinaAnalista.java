 ...
 */
@Entity
@Table(name = "SG_OFICINA_ANALISTA")
@SequenceGenerator(sequenceName = "sg_oficina_analista_id_seq", name = "sg_oficina_analista_seq", allocationSize = 1)
@NamedQueries({
    @NamedQuery(name = "SgOficinaAnalista.findAll", query = "SELECT s FROM SgOficinaAnalista s")})
public class SgOficinaAnalista implements Serializable {
    private static final long serialVersionUID = 1L;
    @Id
@GeneratedValue(generator =  "sg_oficina_analista_seq", strategy = GenerationType.SEQUENCE)
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SgOficinaAnalista)) {
            return false;
        }
        SgOficinaAnalista other = (SgOficinaAnalista) object;
    ...
    public String toString() {
        ...
        sb.append(this.getClass().getName())
            ...
            .append(", analista=").append(this.analista != null ? this.analista.getId() : null)                

 ...
 */
@Entity
@Table(name = "SG_VIAJE_VEHICULO")
@SequenceGenerator(sequenceName = "sg_viaje_vehiculo_id_seq", name = "sg_viaje_vehiculo_seq", allocationSize = 1)
@NamedQueries({
    @NamedQuery(name = "SgViajeVehiculo.findAll", query = "SELECT s FROM SgViajeVehiculo s")})
public class SgViajeVehiculo implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
@GeneratedValue(generator =  "sg_viaje_vehiculo_seq", strategy = GenerationType.SEQUENCE)
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SgViajeVehiculo)) {
            return false;
        }
        SgViajeVehiculo other = (SgViajeVehiculo) object;

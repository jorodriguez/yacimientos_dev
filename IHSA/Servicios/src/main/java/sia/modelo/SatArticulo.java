...
@Getter
@Setter
@Table(name = "SAT_ARTICULO")
@SequenceGenerator(sequenceName = "sat_articulo_id_seq", name = "sat_articulo_seq", allocationSize = 1)
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "SatArticulo.findAll", query = "SELECT o FROM SatArticulo o")})
public class SatArticulo implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
@GeneratedValue(generator =  "sat_articulo_seq", strategy = GenerationType.SEQUENCE)
    ...
    public boolean equals(Object object) {        
        SatArticulo other = (SatArticulo) object;

 ...
 */
@Entity
@Table(name = "OC_YACIMIENTO")
@SequenceGenerator(sequenceName = "oc_yacimiento_id_seq", name = "oc_yacimiento_seq", allocationSize = 1)
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "OcYacimiento.findAll", query = "SELECT o FROM OcYacimiento o")})
@Setter
@Getter
public class OcYacimiento implements Serializable {
    private static final long serialVersionUID = 1L;
    
    public OcYacimiento(){    
        
    }
    public OcYacimiento(int id){
        this.id = id;
    }
    
    @Id
@GeneratedValue(generator =  "oc_yacimiento_seq", strategy = GenerationType.SEQUENCE)
...
//
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof OcYacimiento)) {
            return false;
        }
        OcYacimiento other = (OcYacimiento) object;

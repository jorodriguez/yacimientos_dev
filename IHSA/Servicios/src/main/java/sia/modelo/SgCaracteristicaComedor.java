 ...
 */
@Entity
@Table(name = "SG_CARACTERISTICA_COMEDOR")
@SequenceGenerator(sequenceName = "sg_caracteristica_comedor_id_seq", name = "sg_caracteristica_comedor_seq", allocationSize = 1)
@NamedQueries({
    @NamedQuery(name = "SgCaracteristicaComedor.findAll", query = "SELECT s FROM SgCaracteristicaComedor s")})
public class SgCaracteristicaComedor implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
@GeneratedValue(generator =  "sg_caracteristica_comedor_seq", strategy = GenerationType.SEQUENCE)
    ...
    @JoinColumn(name = "SG_COMEDOR", referencedColumnName = "ID")
    ...
    public SgCaracteristicaComedor() {
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SgCaracteristicaComedor)) {
            return false;
        }
        SgCaracteristicaComedor other = (SgCaracteristicaComedor) object;
    ...
    public String toString() {
        ...
        sb.append(this.getClass().getName())
            ...
            .append(", sgComedor=").append(this.sgComedor != null ? this.sgComedor.getId() : null)

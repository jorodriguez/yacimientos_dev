 ...
 */
@Entity
@Table(name = "OC_PRODUCTO")
@SequenceGenerator(sequenceName = "oc_producto_id_seq", name = "oc_producto_seq", allocationSize = 1)
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "OcProducto.findAll", query = "SELECT o FROM OcProducto o")})
@Setter
@Getter
public class OcProducto implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
@GeneratedValue(generator =  "oc_producto_seq", strategy = GenerationType.SEQUENCE)
...
//
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof OcProducto)) {
            return false;
        }
        OcProducto other = (OcProducto) object;

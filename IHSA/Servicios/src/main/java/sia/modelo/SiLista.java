...
@Setter
@Table(name = "SI_LISTA")
@SequenceGenerator(sequenceName = "si_lista_id_seq", name = "si_lista_seq", allocationSize = 1)
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "SiLista.findAll", query = "SELECT o FROM SiLista o")})
public class SiLista implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
@GeneratedValue(generator =  "si_lista_seq", strategy = GenerationType.SEQUENCE)
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SiLista)) {
            return false;
        }
        SiLista other = (SiLista) object;

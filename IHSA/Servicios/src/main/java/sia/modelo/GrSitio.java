...
@Setter
@Table(name = "GR_SITIO")
@SequenceGenerator(sequenceName = "gr_sitio_id_seq", name = "gr_sitio_seq", allocationSize = 1)
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "GrSitio.findAll", query = "SELECT o FROM GrSitio o")})
public class GrSitio implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
@GeneratedValue(generator =  "gr_sitio_seq", strategy = GenerationType.SEQUENCE)
    ...
    public String toString() {
        ...
        sb.append(", liga=").append(this.liga != null ? this.liga : null);

...
@Getter
@Setter
@Table(name = "GR_ARCHIVO")
@SequenceGenerator(sequenceName = "gr_archivo_id_seq", name = "gr_archivo_seq", allocationSize = 1)
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "GrArchivo.findAll", query = "SELECT o FROM GrArchivo o")})
public class GrArchivo implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
@GeneratedValue(generator =  "gr_archivo_seq", strategy = GenerationType.SEQUENCE)
    ...
    @JoinColumn(name = "GR_TIPO_ARCHIVO", referencedColumnName = "ID")
    @ManyToOne
    private GrTipoArchivo grTipoArchivo;
	...
	if (!(object instanceof GrArchivo)) {
	    return false;
	}
	GrArchivo other = (GrArchivo) object;
	...
	sb.append(", grMapa=").append(this.grMapa != null ? this.grMapa.getId() : null);
	sb.append(", grTipoArchivo=").append(this.grTipoArchivo != null ? this.grTipoArchivo.getId() : null);
	sb.append(", siAdjunto=").append(this.siAdjunto != null ? this.siAdjunto.getId() : null);
	sb.append(", SgSemaforo=").append(this.sgSemaforo != null ? this.sgSemaforo.getId() : null);
	...
	sb.append(", titulo=").append(this.titulo != null ? this.titulo : null);
	sb.append("}");

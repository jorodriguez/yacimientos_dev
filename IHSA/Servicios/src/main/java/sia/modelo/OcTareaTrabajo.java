 ...
 */
@Entity
@Table(name = "OC_TAREA_TRABAJO")
@SequenceGenerator(sequenceName = "oc_tarea_trabajo_id_seq", name = "oc_tarea_trabajo_seq", allocationSize = 1)
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "OcTareaTrabajo.findAll", query = "SELECT o FROM OcTareaTrabajo o")})
@Setter
@Getter
public class OcTareaTrabajo implements Serializable {
...
//
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof OcTareaTrabajo)) {
            return false;
        }
        OcTareaTrabajo other = (OcTareaTrabajo) object;

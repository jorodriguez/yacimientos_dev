...
@Entity
@Table(name = "SG_COLOR")
@SequenceGenerator(sequenceName = "sg_color_id_seq", name = "sg_color_seq", allocationSize = 1)
@NamedQueries({
    @NamedQuery(name = "SgColor.findAll", query = "SELECT c FROM SgColor c")})
public class SgColor implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
@GeneratedValue(generator =  "sg_color_seq", strategy = GenerationType.SEQUENCE)
	...
	if (!(object instanceof SgColor)) {
	    return false;
	}
	SgColor other = (SgColor) object;

...
@Getter
@Setter
@Table(name = "GR_TIPO_ARCHIVO")
@SequenceGenerator(sequenceName = "gr_tipo_archivo_id_seq", name = "gr_tipo_archivo_seq", allocationSize = 1)
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "GrTipoArchivo.findAll", query = "SELECT o FROM GrTipoArchivo o")})
public class GrTipoArchivo implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
@GeneratedValue(generator =  "gr_tipo_archivo_seq", strategy = GenerationType.SEQUENCE)
    ...
    public GrTipoArchivo() {
    }

    public GrTipoArchivo(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        GrTipoArchivo other = (GrTipoArchivo) object;

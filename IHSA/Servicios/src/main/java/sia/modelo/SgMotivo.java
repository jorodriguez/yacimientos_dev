 ...
 */
@Entity
@Table(name = "SG_MOTIVO")
@SequenceGenerator(sequenceName = "sg_motivo_id_seq", name = "sg_motivo_seq", allocationSize = 1)
@NamedQueries({
...
public class SgMotivo implements Serializable {
    ...
    @OneToMany(mappedBy = "sgMotivo")
    private Collection<SgSolicitudViaje> sgSolicitudViajeCollection;
    private static final long serialVersionUID = 1L;
    @Id
@GeneratedValue(generator =  "sg_motivo_seq", strategy = GenerationType.SEQUENCE)
    @Basic(optional = false)
    @NotNull
    @Column(name = "ID")
    private Integer id;

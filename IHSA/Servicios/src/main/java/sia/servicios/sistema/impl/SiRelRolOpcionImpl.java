...
public class SiRelRolOpcionImpl extends AbstractFacade<SiRelRolOpcion>{
	...
	if (relRolOpcion.getId() != null) {
	    ...
	    rro.setGenero(new Usuario(Constantes.USUARIO_SIA));
	    rro.setModifico(new Usuario(Constantes.USUARIO_SIA));
	    create(rro);
	...
	String sb = "select o.id,  o.NOMBRE, o.PAGINA, \n"
		...
		+ "                            inner join AP_CAMPO_GERENCIA cg on cg.GERENCIA = g.ID  and cg.AP_CAMPO = " + Constantes.AP_CAMPO_DEFAULT + "\n"

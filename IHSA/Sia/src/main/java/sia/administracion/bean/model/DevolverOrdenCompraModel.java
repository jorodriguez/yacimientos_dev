...
//        o.setMontoTotalDolares((Double) objects[5]);
    ...
    public boolean pasarOrdenesCompra() {
        ...
        exito = ordenServicioRemoto.pasarOrdenesCompra(lo, getIdStatus(), getUsuarioSolicita(), getUsuarioAprobara(), sesion.getUsuarioVo().getId(),
    ...
    public boolean pasarRequisiciones() {
        ...
        exito = requisicionImpl.pasarRequisiciones(lo, getIdStatus(), getUsuarioSolicita(), getUsuarioAprobara(), sesion.getUsuarioVo().getId(),
                sesion.getUsuarioVo().getRfcEmpresa(), sesion.getUsuarioVo().getMail());
        buscarRequisiones();

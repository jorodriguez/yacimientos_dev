 ...
 * @author rluna MLUIS
 */
@Named(value = "catalogoApGerenciaBeanModel")
@ViewScoped
...
//    }
	...
	UtilLog4j.log.info(this, "Entrando a guardar nombre de gerencia");
	apCampoUsuarioRhPuestoImpl.save(this.sesion.getUsuario().getId(), idCampo,  usuarioBean.getUsuarioVOAlta().getId(), idPuesto, idGerencia);
    }

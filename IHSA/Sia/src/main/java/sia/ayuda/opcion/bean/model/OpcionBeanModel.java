...
public class OpcionBeanModel implements Serializable {
    ...
    /**
     * @param opcionesFiltradasByModuloDataModel the
     * opcionesFiltradasByModuloDataModel to set
     */
    ...
    /**
     * @param opcionesListFiltradasByModulo the opcionesListFiltradasByModulo to
     * set
     */
...
//    }
    ...
    public void ÁrbolOpcionBean() {
        ///out.println("Entró ÁrbolOpcionBean Constructor----------------------->");

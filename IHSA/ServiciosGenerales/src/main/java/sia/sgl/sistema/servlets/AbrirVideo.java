 ...
 * @author Héctor
 */
@WebServlet(name = "AbrirVideo", urlPatterns = {"/AbrirVideo"})
public class AbrirVideo extends HttpServlet {
	...
	try {
	    ...
	    UtilLog4j.log.info(this, "Dentro del servlet Abrir video");
	    ...
	    UtilLog4j.log.fatal(this, "Ocurrio un error al abrir el video  : :: : : : " + e.getMessage());

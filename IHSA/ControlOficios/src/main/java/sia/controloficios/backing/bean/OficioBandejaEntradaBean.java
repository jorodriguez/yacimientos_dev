...
public class OficioBandejaEntradaBean extends OficioBaseBean {
    ...
    private DataTable dataTableOficiosEntrada;
    ...
    public String crearNuevoOficio(){
               
        //removeContextParam(OFICIO_ID);
        setContextParamOficioId(0);
    ...
    */
    ...
    public String goDetalleTestConParams(int id) {
        System.out.println("goDetalleTestConParams " + id);
        return "detalle_test.xhtml?oficioId=" + id + "&faces-redirect=true;";
    }

    public DataTable getDataTableOficiosEntrada() {
        return dataTableOficiosEntrada;
    }

    public void setDataTableOficiosEntrada(DataTable dataTableOficiosEntrada) {
        this.dataTableOficiosEntrada = dataTableOficiosEntrada;
    }

...
public class OcProveedorConPagoImpl extends AbstractFacade<OcProveedorConPago>{
    ...
    public void create(OcProveedorConPago ocProveedorConPago) {
        em.persist(ocProveedorConPago);
    }

    
    public void edit(OcProveedorConPago ocProveedorConPago) {
        em.merge(ocProveedorConPago);
    }

    
    public void remove(OcProveedorConPago ocProveedorConPago) {
        em.remove(em.merge(ocProveedorConPago));
    }

    
    public OcProveedorConPago find(Object id) {
        return em.find(OcProveedorConPago.class, id);
    }

    
    public List<OcProveedorConPago> findAll() {
        return em.createQuery("select object(o) from OcProveedorConPago as o").getResultList();
    }

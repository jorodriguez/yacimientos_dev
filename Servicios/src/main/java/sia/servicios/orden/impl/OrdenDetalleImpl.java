...
public class OrdenDetalleImpl extends AbstractFacade<OrdenDetalle>{
    ...
    public void remove(OrdenDetalle ordenDetalle) {
        em.remove(em.merge(ordenDetalle));
    }

    
    public OrdenDetalle find(Object id) {
        return em.find(OrdenDetalle.class, id);
    }

    
    public List<OrdenDetalle> findAll() {
        return em.createQuery("select object(o) from OrdenDetalle as o").getResultList();
    }

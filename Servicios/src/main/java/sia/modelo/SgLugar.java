...
@Entity
@Table(name = "SG_LUGAR")
@SequenceGenerator(sequenceName = "sg_lugar_id_seq", name = "sg_lugar_seq", allocationSize = 1)
@NamedQueries({
    @NamedQuery(name = "SgLugar.findAll", query = "SELECT l FROM SgLugar l")})
public class SgLugar implements Serializable {
    private static final long serialVersionUID = 1L;
    @Id
@GeneratedValue(generator =  "sg_lugar_seq", strategy = GenerationType.SEQUENCE)

...
//    private Date horaFin;
    ...
    private List<SemaforoVo> listaRutaOficina = new ArrayList<SemaforoVo>();
    private List<SemaforoVo> listaRutaCiudad = new ArrayList<SemaforoVo>();
    private List<SemaforoVo> listaRutaLugar = new ArrayList<SemaforoVo>();

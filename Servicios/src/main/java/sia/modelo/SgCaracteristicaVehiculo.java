 ...
 */
@Entity
@Table(name = "SG_CARACTERISTICA_VEHICULO")
@SequenceGenerator(sequenceName = "sg_caracteristica_vehiculo_id_seq", name = "sg_caracteristica_vehiculo_seq", allocationSize = 1)
@NamedQueries({
    @NamedQuery(name = "SgCaracteristicaVehiculo.findAll", query = "SELECT s FROM SgCaracteristicaVehiculo s")})
public class SgCaracteristicaVehiculo implements Serializable {
    private static long serialVersionUID = 1L;
    @Id
@GeneratedValue(generator =  "sg_caracteristica_vehiculo_seq", strategy = GenerationType.SEQUENCE)
    ...
    public SgCaracteristicaVehiculo() {
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SgCaracteristicaVehiculo)) {
            return false;
        }
        SgCaracteristicaVehiculo other = (SgCaracteristicaVehiculo) object;
    ...
    public String toString() {
        ...
        sb.append(this.getClass().getName())
            ...
            .append(", sgVehiculo=").append(this.sgVehiculo != null ? this.getSgVehiculo().getId() : null)
            ...
            .append(", fechaModifico=").append(this.getFechaModifico() != null ? (sdfd.format(this.getFechaModifico())) : null)
            .append(", horaModifico=").append(this.getHoraModifico() != null ? (sdft.format(this.getHoraModifico())) : null)

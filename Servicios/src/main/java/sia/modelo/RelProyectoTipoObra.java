 ...
 */
@Entity
@Table(name = "REL_PROYECTO_TIPO_OBRA")
@SequenceGenerator(sequenceName = "rel_proyecto_tipo_obra_id_seq", name = "rel_proyecto_tipo_obra_seq", allocationSize = 1)
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "RelProyectoTipoObra.findAll", query = "SELECT r FROM RelProyectoTipoObra r")})
public class RelProyectoTipoObra implements Serializable {
    ...
    @Id
@GeneratedValue(generator =  "rel_proyecto_tipo_obra_seq", strategy = GenerationType.SEQUENCE)
    ...
    public RelProyectoTipoObra() {
    }

    public RelProyectoTipoObra(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RelProyectoTipoObra)) {
            return false;
        }
        RelProyectoTipoObra other = (RelProyectoTipoObra) object;
    ...
    public String toString() {
        ...
        sb.append(this.getClass().getName())
            ...
            .append(", tipoObra=").append(this.tipoObra != null ? this.tipoObra.getId() : null)

...
@Entity
@Table(name = "SG_MARCA")
@SequenceGenerator(sequenceName = "sg_marca_id_seq", name = "sg_marca_seq", allocationSize = 1)
@NamedQueries({
    @NamedQuery(name = "SgMarca.findAll", query = "SELECT s FROM SgMarca s")})
public class SgMarca implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
@GeneratedValue(generator =  "sg_marca_seq", strategy = GenerationType.SEQUENCE)
	...
	if (!(object instanceof SgMarca)) {
	    return false;
	}
	SgMarca other = (SgMarca) object;
